...
//#include <OpenMesh/Core/Math/VectorT.hh> // openmesh 1.1.x
#include <OpenMesh/Core/Geometry/VectorT.hh> // openmesh 2.x



//=============================================================================
namespace GL { //包装了OpenGL的函数
//=============================================================================

// 本来Mario Botsch在这个mesh courses中是使用openmesh1.0.0的,
// 但是现在我改为openmesh1.1.0的了, 主要的改动在原来的VectorT类需要.data()函数啦获取其数据
